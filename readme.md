...
nav_order: 1
permalink: /
description: "强化学习教程从入门到精通，适合有 SLAM / 定位建图背景的工程师"
---
...
### [第二章：数学工具箱——你需要知道的背景知识](chapter02)
...
### [第三章：马尔可夫决策过程（MDP）——强化学习的数学语言](chapter03)
...
### [第四章：动态规划——用完美信息求解 MDP](chapter04)
...
### [第五章：无模型预测——蒙特卡洛与时序差分学习](chapter05)
...
### [第六章：无模型控制——Q-Learning 与 Sarsa](chapter06)
...
### [第九章：Actor-Critic 架构——价值与策略的协同](chapter09)
...
### [第十章：PPO——现代机器人 RL 的主力算法](chapter10)
...
### [第十二章：从仿真到现实——机器人 RL 的工程挑战](chapter12)
...
| 我想了解… | 去哪读 |
|---|---|
| RL 是什么，和深度学习有什么区别 | [第一章](chapter01) |
| 强化学习的数学基础，MDP 是什么 | [第三章](chapter03) |
| Bellman 方程怎么推导的 | [第四章](chapter04) |
| Q-Learning 怎么工作的 | [第六章](chapter06) |
| DQN 为什么需要经验回放和目标网络 | [第七章](chapter07) |
| PPO 的 clip 目标函数是怎么来的 | [第十章](chapter10) |
| 为什么用 SAC 而不是 PPO | [第十一章](chapter11) |
| 机器人仿真训练为什么在真机上不好用 | [第十二章](chapter12) |
| 下一步读什么论文和书 | [第十三章](chapter13) |
